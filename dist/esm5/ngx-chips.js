...
var TagInputVirtualizedDropdown = /** @class */ (function () {
    ...
    TagInputVirtualizedDropdown.prototype.ngOnInit = function () {
        ...
        this.tagInput
            .onTextChange
            .asObservable()
            .pipe(debounceTime(200), filter(function (text) { return !_this.keepOpen
            ? text.trim().length > 0
            : true; }))
            .subscribe(this.show);
        if (this.totalOfItemsObservable) {
            this.vScroll
                .end
                .asObservable()
                .pipe(debounceTime(350), filter(function (e) {
                if (e.end === undefined) {
                    return false;
                }
            ...
            }), switchMap(function () { return _this.totalOfItemsObservable(_this.tagInput.inputTextValue); }), filter(function (total) { return _this.autocompleteItems.length < total; }))
...
var defaults$3 = forwardRef(function () { return OptionsProvider.defaults.tagInput; });
var TagInputComponent = /** @class */ (function (_super) {
    ...
    TagInputComponent.prototype.setUpTextChangeSubscriber = function () {
        ...
        this.inputForm.form
            .valueChanges
            .pipe(debounceTime(this.onTextChangeDebounce), filter(function (value) { return value.item.length > 0; }))
